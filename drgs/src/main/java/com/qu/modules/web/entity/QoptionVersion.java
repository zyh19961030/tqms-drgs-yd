 ...
 */
@Data
@TableName("qoption_version")
@EqualsAndHashCode(callSuper = false)
@Accessors(chain = true)
@ApiModel(value="qoption_version对象", description="选项版本表")
public class QoptionVersion {
	...
	/**题目版本表id*/
	@Excel(name = "题目版本表id", width = 15)
    @ApiModelProperty(value = "题目版本表id")
	private String subjectVersionId;
	/**题目id*/
	@Excel(name = "题目id", width = 15)
    @ApiModelProperty(value = "题目id")
	private Integer subjectId;
	/**选项id*/
	@Excel(name = "选项id", width = 15)
