...
@ApiModel(value="TbFollowVisitPatientTemplateAllPatientListParam", description="TbFollowVisitPatientTemplateAllPatientListParam")
public class TbFollowVisitPatientTemplateAllPatientListParam {
