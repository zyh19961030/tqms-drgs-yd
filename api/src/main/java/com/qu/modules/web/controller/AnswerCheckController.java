...
public class AnswerCheckController {
	...
	private IAnswerCheckService answerCheckService;
	 ...
	 @ApiOperation(value = "检查表问卷_查检表登记_填报中分页列表", notes = "检查表问卷_查检表登记_填报中分页列表")
    ...
    @ApiOperation(value = "统计_查检数量统计", notes = "统计_查检数量统计",response = CheckQuestionCountStatisticVo.class)
    @PostMapping(value = "/checkQuestionCountStatistic")
    public ResultBetter<List<CheckQuestionCountStatisticVo>> checkQuestionCountStatistic(@RequestBody @Valid CheckQuestionCountStatisticParam statisticParam) {
        ResultBetter<List<CheckQuestionCountStatisticVo>> result = new ResultBetter<>();
        List<CheckQuestionCountStatisticVo> vo =  answerCheckService.checkQuestionCountStatistic(statisticParam);
        result.setSuccess(true);
        result.setResult(vo);
        return result;
    }
