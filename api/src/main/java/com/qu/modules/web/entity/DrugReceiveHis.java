...
@ApiModel(value="drug_receive_his对象", description="药品规则接收his数据表")
public class DrugReceiveHis {
	...
	/**用药目的名称*/
	@Excel(name = "用药目的名称", width = 15)
    @ApiModelProperty(value = "用药目的名称")
	private String medicationPurposeName;
	/**药品物理作用id*/
	@Excel(name = "药品物理作用id", width = 15)
    @ApiModelProperty(value = "药品物理作用id")
	private Integer drugPhysicalActionId;
	/**药品物理作用名称*/
	@Excel(name = "药品物理作用名称", width = 15)
    @ApiModelProperty(value = "药品物理作用名称")
	private String drugPhysicalActionName;
	/**上级id*/
